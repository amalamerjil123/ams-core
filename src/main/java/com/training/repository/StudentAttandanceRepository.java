...
public interface StudentAttandanceRepository {
	...
	void updateStudentAttendanceStatus(StudentAttandance student, LocalDateTime modifiedDate);

	void updateAllStudentsAttendanceStatus(List<StudentAttandance> student, LocalDateTime modifiedDate);

	List<StudentAttendanceDTO> getStudentAttendanceList(String userName);

	void updateStudentAttendance(StudentAttendanceDTO student, LocalDateTime modifiedDate);

	void updateAllStudentAttendance(List<StudentAttendanceDTO> student, LocalDateTime today);
	...
	List<StudentAttendanceDTO> getStudentAttendanceInReviewListByCollege(String college);
